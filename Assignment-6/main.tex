...
\begin{align}
\mathcal{S_A} &= \{ (x,y) : x+y=6 \And x,y \in \{ 1,2 \ldots 6\}\} \\
\mydet{\mathcal{S_A}} &= 5
\end{align}
The event that $X_2=1$ is given by
\begin{align}
\mathcal{S_B} &= \{ (4,x) \cup (x,4) : x \in \{ 1,2 \ldots 6\}\} \\
\mydet{\mathcal{S_B}} &= 11
\end{align}
The event that $X_1=1 \And X_2=1$ is given by
\begin{align}
\mathcal{S_{A \cap B}} &= \{ (2,4),(4,2)\} \\
\mydet{\mathcal{S_{A \cap B}}} &= 2
\end{align}
